...
export const ResetPasswordPage = () => { 
    ...
    <div className="bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-950 min-h-screen flex flex-col justify-center items-center text-white relative overflow-hidden">
        ...
        <div className="relative z-10 backdrop-blur-sm bg-white/5 p-8 md:p-12 rounded-2xl border border-white/10 shadow-2xl max-w-2xl w-full mx-4">
            ...
            <p className="text-gray-200 text-md md:text-xl mb-6 px-5">Por favor, ingresa tu nueva contraseña.</p>
            <div className="relative">
              <FormInput
                  className="text-md md:text-2xl mt-8 p-2 rounded"
                  inputName='Nueva Contraseña'
                  inputProps={{
                    className: "text-md md:text-xl bg-white/10 backdrop-blur-md border border-cyan-400/50 p-3 my-2 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent transition-all duration-300 pr-12",
        ...
        {resetToken === '' && (
            <div className="relative z-10 backdrop-blur-sm bg-white/5 p-8 md:p-12 rounded-2xl border border-white/10 shadow-2xl max-w-2xl w-full mx-4">
                <h1 className="m-5 text-2xl md:text-4xl font-bold bg-gradient-to-r from-cyan-400 to-fuchsia-500 bg-clip-text text-transparent">Token inválido o expirado</h1>
                <p className="text-gray-200 text-md md:text-xl mb-6 px-5">El enlace de restablecimiento de contraseña no es válido o ha expirado. Por favor, solicita un nuevo enlace.</p>
                <Button 
                    className="bg-gradient-to-r from-cyan-500 to-fuchsia-600 hover:from-cyan-400 hover:to-fuchsia-500 text-white font-bold py-3 px-8 rounded-lg shadow-lg hover:shadow-cyan-500/50 hover:scale-105 transition-all duration-300 transform" 

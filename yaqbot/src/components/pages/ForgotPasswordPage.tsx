    ...
    <HeaderImage height="100vh" imageUrl="/bg/plants-5.webp" overlayOpacity={0.4}>
      ...
      <div className="relative z-10 backdrop-blur-sm bg-black/50 p-8 md:p-12 rounded-2xl border border-white/10 shadow-2xl max-w-2xl w-full mx-4">
        ...
        <p className="text-gray-200 text-md md:text-xl mb-6 px-5">
          Por favor, ingresa tu correo electrónico para recibir un enlace de restablecimiento de
          contraseña.
        </p>
        <FormInput
          ...
          inputProps={{
            className:
              'text-md md:text-xl bg-white/10 backdrop-blur-md border border-cyan-400/50 p-3 my-2 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent transition-all duration-300',
            inputType: 'email',
            id: 'emailInput',
